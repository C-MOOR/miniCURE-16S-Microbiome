...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "A title slide for the lecture titled: Introduction to 16S rRNA Data Using Spreadsheets. The C-MOOR logo is shown in the bottom left corner."}
