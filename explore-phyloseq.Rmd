...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "A title slide for the lecture titled: Exploring 16S rRNA Data with phyloseq. The C-MOOR logo is shown in the bottom left corner."}
