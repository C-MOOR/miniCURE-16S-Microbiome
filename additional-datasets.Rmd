...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An image showing the FeFiFo study design."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dEZtb0TgLbzhbr3HxQElwg8hENur2HMIzseg19OGd0g/edit#slide=id.g36eaabae9be_0_25")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An image showing the metadatavariables available from the Alzheimer's study including age, sex, and whether the subject had Alzheimer's."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dEZtb0TgLbzhbr3HxQElwg8hENur2HMIzseg19OGd0g/edit#slide=id.g36eaabae9be_0_235")
```
